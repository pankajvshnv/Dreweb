        ...
        <div className="bg-white border border-zinc-200 rounded-[24px] p-8 shadow-sm">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="relative flex items-center py-2">
              ...
              <span className="flex-shrink-0 mx-4 text-zinc-400 text-xs">Or continue with</span>
              <div className="flex-grow border-t border-zinc-200"></div>
            </div>
            ...
            <Button 
              type="button" 
              variant="outline"
              className="w-full h-12 rounded-xl border-zinc-200 hover:bg-zinc-50 font-bold text-base"
