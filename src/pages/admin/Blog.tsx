              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <Textarea id="featuredImagePrompt" value={formData.featuredImagePrompt} onChange={handleChange} placeholder="Prompt generated by n8n will appear here..." className="min-h-[80px] border-zinc-200 rounded-xl bg-zinc-50 focus:bg-white transition-colors" />
                    <p className="text-xs text-zinc-500">Copy this prompt into Midjourney or DALL-E to generate your cover image.</p>
                  </div>
                </div>
                    ...
                    <td className="px-6 py-4 text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="rounded-xl border-zinc-200">
                          ...
                          <DropdownMenuSeparator />
                          <DropdownMenuItem onSelect={(e) => { e.preventDefault(); setTimeout(() => handleDelete(post.id), 50); }} className="text-red-600 focus:bg-red-50 focus:text-red-700 font-bold cursor-pointer">Delete</DropdownMenuItem>
                        </DropdownMenuContent>
                      </DropdownMenu>
                    </td>
                  </tr>
